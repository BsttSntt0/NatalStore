...
import { Save, QrCode, CreditCard, Landmark, ArrowLeft, Shield } from 'lucide-react';
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Tipo de Chave / Chave Pix</label>
                  <input
                    type="text"
                    name="pixKey"
                    ...
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-christmas-green focus:border-transparent outline-none transition-all"
                  />
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Provedor / Adquirente</label>
                  <input
                    type="text"
                    name="creditProvider"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">ID do Estabelecimento / Chave de API</label>
                  <input
                    type="text"
                    name="merchantId"
